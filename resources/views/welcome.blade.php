...
@section('content')
    ...
    <div class="relative flex flex-col w-full max-w-[640px] min-h-screen gap-5 mx-auto bg-[#F5F5F0]">
                    ...
                    <a href="{{route('front.category', $itemCategory->slug)}}">
                        <div
                            ...
                            <div class="flex flex-col gap-[2px] px-[14px]">
                                ...
                                <p class="text-xs leading-[18px] text-[#878785]">{{$itemCategory->products->count()}} Produk
                                </p>
                            </div>
                            <div class="flex shrink-0 w-20 h-[90px] overflow-hidden">
                                <img src="{{Storage::url($itemCategory->icon)}}" class="w-full h-full object-cover object-left"
                                    alt="thumbnail">
                            </div>
                        </div>
                    </a>
        ...
        <section id="featured" class="flex flex-col gap-4">
            ...
            <div class="swiper w-full overflow-auto">
                                ...
                                <a href="{{route('front.details', $itemPopularProduct->slug)}}">
                                    <div
                                        ...
                                        <div class="w-[210px] h-[230px] rounded-3xl bg-[#D9D9D9] overflow-hidden">
                                            <img src="{{Storage::url($itemPopularProduct->thumbnail)}}"
                                        ...
                                        <div class="flex flex-col gap-[14px] justify-between">
                                            <div class="flex items-center justify-between gap-4">
                                                ...
                                                <p class="font-bold text-sm leading-[21px] text-nowrap">Rp
                                                    {{number_format($itemPopularProduct->price, 0, ',', '.')}}
                                                </p>
                                            </div>
